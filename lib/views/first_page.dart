  ...
  void _determinePosition() async {
    ...
    if (!serviceEnabled) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
              translation(context).location_disabled))); //Falta comprob
      return;
    }
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(translation(context).location_permissions))); //falta comprobar
        return;
      }
    }
    ...
    if (permission == LocationPermission.deniedForever) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
              translation(context).location_permissions_permanent))); //falta comprob
      return;
    }
        ...
        appBar: AppBar(
          ...
          Visibility(
            ...
            child: IconButton(
              ...
              tooltip: translation(context).iniciate_videocall, //falta comprobar
              onPressed: () {
                Navigator.push(
                        context,
                        MaterialPageRoute(
                    ...
                    children: [
                      Flexible(
                        ...
                        child: TextFieldSearcher(
                          label: translation(context).start_point, // falta comprobar
                          apiKey: apiKey,
                          controller: startPointController,
                          getSelectedValue: (value) {
                            print("lloc es: ${value.textName}"); // Aquest i el de baix no sé com fer-ho aixi que al final ho miro
                      ...
                      Flexible(
                          ...
                          child: DateTimePicker(
                            ...
                            dateLabelText: translation(context).select_date, // Falta comprobar
