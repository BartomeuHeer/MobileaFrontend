                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                ...
                                child: ListView(children: [
                                  if (userServices.userData.routes != null)
                                    ListView.builder(
                                      physics:
                                      ...
                                      shrinkWrap: true,
                                      itemCount:
                                          userServices.userData.routes!.length,
                                    ),
                                ]),
                              ),
                            ]),
                            ...
                            child: Column(
                                ...
                                children: <Widget>[
                                  ListTile(
                                    ...
                                    subtitle:
                                        const Text('Insert route information'),
                                  ),
                                ]),
                          ),
                        if (newRoute)
